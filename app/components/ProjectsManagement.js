...
export default function ProjectsManagement() {
  ...
  return (
    <div className="p-6 bg-white min-h-screen transition-all duration-500">
      ...
      {/* Error Banner */}
      {error && (
        <div className="mb-2 p-4 bg-red-50 rounded-lg text-red-700">
      ...
      {projects.length === 0 && !loading ? (
        <div className="text-center py-16 bg-white/30 backdrop-blur-sm rounded-3xl border border-gray-100/50">
          ...
          <button
            onClick={() => handleOpenDialog()}
            className="bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 text-white px-6 py-3 rounded-xl font-semibold transition-all duration-300 hover:scale-105 shadow-lg shadow-blue-200/50"
            type="button"
          >
        ...
        <div className="col-span-full text-center py-16 bg-white/30 backdrop-blur-sm rounded-3xl border border-gray-100/50">
          <div className="text-6xl mb-4">🔍</div>
          <h3 className="text-xl font-bold text-gray-700 mb-2">
            No Projects Found
          </h3>
                  ...
                  <div className="bg-rose-100 rounded-xl p-3 text-center border border-rose-200 shadow-sm">
                    ...
                    <div className="text-base font-bold text-rose-900">
                      {project.endDate
                        ? (() => {
                            try {
                              return format(parseISO(project.endDate), "MMM d");
                            } catch {
                              return "Not set";
                            }
                          })()
                    ...
                    <div className="text-xs text-rose-500 mt-1">
                      {project.endDate
                        ? (() => {
                            try {
                              return format(parseISO(project.endDate), "yyyy");
                            } catch {
                              return "";
                            }
                          })()
