...
import { Activity, Shield, TrendingUp, BarChart3, ClipboardList, AlertTriangle, UserCheck } from "lucide-react";
...
const TABS = [
  ...
  { id: "completed-activities", label: "Completed Activities (Master Audit)", icon: ClipboardList, component: CompletedActivitiesMasterAuditReport },
  { id: "workflow-bottlenecks", label: "Workflow Bottleneck & SLA Breach", icon: AlertTriangle, component: WorkflowBottleneckSLAReport },
  { id: "user-activity-security", label: "User Activity & Security Audit", icon: UserCheck, component: UserActivitySecurityAuditReport },
];
      ...
      <div className="max-w-7xl mx-auto">
        <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
          ...
          <p className="text-gray-600 mb-6">
            9.1–9.4 Executive Reports • 10.1 Completed Activities (Master Audit) • 10.2 Workflow Bottleneck & SLA Breach • 10.3 User Activity & Security Audit
          </p>
