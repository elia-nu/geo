...
const ProjectsPage = () => {
  ...
  async function handleProgressUpdate() {
    ...
    try {
      setError(null);
      const res = await fetch(`/api/projects/${selectedProjectForProgress._id}`, {
        method: "PUT",
        headers: { "Content-Type": "application/json" },
      ...
      <div className="p-6 bg-white min-h-screen transition-all duration-500">
        ...
        {projects.length === 0 && !loading ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-7xl mx-auto">
            {filteredProjects.map((project) => (
              <div
                key={project._id}
                className="group relative h-[600px] w-full flex flex-col bg-white rounded-2xl shadow-sm hover:shadow-md transition-all duration-300 border border-gray-200 overflow-hidden flex-shrink-0"
              >
                {/* Status Bar - Made White */}
                <div>
                ...
                <div className="flex-grow p-6 flex flex-col">
                  ...
                  <div className="mb-4 bg-white rounded-xl p-4 border border-gray-200">
                    ...
                    <div className="relative">
                      <div className="w-full bg-gray-100 rounded-full h-3 overflow-hidden">
                        <div
                          className="h-3 rounded-full transition-all duration-300 relative overflow-hidden bg-white border border-gray-200"
                  ...
                  <div className="grid grid-cols-3 gap-3 mb-4">
                    <div className="bg-white rounded-xl p-3 text-center border border-gray-200">
                      <div className="w-9 h-9 bg-white border border-gray-200 rounded-full flex items-center justify-center mx-auto mb-2">
                        <PeopleIcon className="text-gray-600 text-base" />
                      </div>
                    ...
                    <div className="bg-white rounded-xl p-3 text-center border border-gray-200">
                      <div className="w-9 h-9 bg-white border border-gray-200 rounded-full flex items-center justify-center mx-auto mb-2">
                        <CalendarIcon className="text-gray-600 text-base" />
                      </div>
                      <div className="text-xs font-semibold text-gray-600 mb-1 uppercase tracking-wide">
                        Start
                      </div>
                    ...
                    <div className="bg-white rounded-xl p-3 text-center border border-gray-200">
                      <div className="w-9 h-9 bg-white border border-gray-200 rounded-full flex items-center justify-center mx-auto mb-2">
                        <FlagIcon className="text-gray-600 text-base" />
                      </div>
                      <div className="text-xs font-semibold text-gray-600 mb-1 uppercase tracking-wide">
                        End
                      </div>
        ...
        {anchorEl && (
          ...
          >
            ...
            >
              <TrendingUpIcon /> Update Progress
            </div>
            <div
        ...
        {openStatusDialog && selectedProjectForStatus && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
            <div className="bg-white rounded-lg shadow-md max-w-md w-full border border-gray-100">
              <div className="p-6">
                <div className="flex items-center gap-2 mb-4">
                ...
                <div className="space-y-3">
                  {STATUS_OPTIONS.filter(option => option.value !== "all").map((option) => {
                    const isCurrentStatus = selectedProjectForStatus.status === option.value;
                    return (
                      <button
                        key={option.value}
              ...
              <div className="flex justify-end gap-3 px-6 pb-6 pt-4 border-t border-gray-100">
                <button
                  className="px-4 py-2 text-gray-600 bg-gray-100 hover:bg-gray-200 rounded-md font-medium transition-all duration-200 border border-gray-200"
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
            <div className="bg-white rounded-lg shadow-md max-w-md w-full border border-gray-100">
              <div className="p-6">
                ...
                <div className="mb-6">
                  ...
                  <input
                    ...
                    style={{
                      background: `linear-gradient(to right, #10b981 0%, #10b981 ${progressValue}%, #e5e7eb ${progressValue}%, #e5e7eb 100%)`
                    }}
                  />
                ...
                <div className="grid grid-cols-2 gap-3 mb-4">
                  <div className={`p-3 rounded-lg border text-center ${progressValue === 0 ? 'bg-gray-50 border-gray-200' : 'bg-white border-gray-100'}`}>
                    <div className="text-lg mb-1">⏸️</div>
                    <div className="text-xs font-medium text-gray-600">Not Started</div>
                  </div>
                  <div className={`p-3 rounded-lg border text-center ${progressValue > 0 && progressValue < 100 ? 'bg-blue-50 border-blue-200' : 'bg-white border-gray-100'}`}>
                ...
                {progressValue === 100 && (
                  <div className="p-3 rounded-lg bg-green-50 border border-green-200 text-center mb-4">
                    <div className="text-lg mb-1">✅</div>
                    <div className="text-sm font-medium text-green-700">Project Complete!</div>
                  </div>
                )}
              </div>
              ...
              <div className="flex justify-end gap-3 px-6 pb-6 pt-4 border-t border-gray-100">
                ...
                <button
                  className="px-4 py-2 bg-green-600 hover:bg-green-700 text-white rounded-md font-medium transition-all duration-200"
